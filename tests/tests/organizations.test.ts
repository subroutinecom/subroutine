  ...
  () => {
    describe("Organization Creation & Management", () => {
      it("should create an organization", async () => {
        ...
        expect(result.data?.name, "Organization name should match").toBe(
          orgName,
        );
        expect(
          result.data?.slug,
    ...
    describe("Organization Members & Invitations", () => {
      ...
      it("should get organization members", async () => {
        ...
        expect(orgDetails.data!.members.length, "Should have 2 members").toBe(
          2,
        );
    ...
    describe("Organization Edge Cases", () => {
      it("should handle empty organization list for new user", async () => {
        ...
        expect(Array.isArray(orgs.data), "Should return empty array").toBe(
          true,
        );
        expect(orgs.data!.length, "New user should have 0 organizations").toBe(
          0,
        );
      });
      ...
      it("should create organization as first member with owner role", async () => {
        ...
        expect(
          orgDetails.data!.members[0].role,
